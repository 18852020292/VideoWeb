...
//	}
	...
	@ResponseBody
	public List<Video> videoSearch(HttpServletRequest request,@RequestParam String videoTitle) {

		List<Video> search = videoService.getVideoByTitle(videoTitle);
//		ModelAndView mv = new ModelAndView();
//		String videoId = search.get(0).getVideoId();
//		Object obj = request.getSession().getAttribute("user");
//		if (obj != null && videoId != null && !videoId.equals("")) {
//			int videoId2 = Integer.parseInt(videoId);
//			// 因为要观看要记录，故要增加观看次数
